...
public class Player extends Model {
    ...
    @JsonProperty("Created_Datetime") private Date createdAt;
    @JsonProperty("Id") private long id;
    @JsonProperty("Last_Login_Datetime") private Date lastLogin;
    @JsonProperty("Leaves") private int leaves;
    @JsonProperty("Level") private int level;
    @JsonProperty("Losses") private int losses;
    @JsonProperty("MasteryLevel") private int masteryLevel;
    @JsonProperty("Name") private String name;
    @JsonProperty("Personal_Status_Message") private String statusMessage;
    @JsonProperty("Region") private String region;
    @JsonProperty("TeamId") private int teamId;
    @JsonProperty("Team_Name") private String teamName;
    @JsonProperty("Tier_Conquest") private TierLeauge tierConquest;
    @JsonProperty("Tier_Duel")private TierLeauge tierDuel;
    @JsonProperty("Tier_Joust") private TierLeauge tierJoust;
    @JsonProperty("Total_Achievements") private int totalAchievements;
    @JsonProperty("Total_Worshippers") private int totalWorshippers;
